        ...
        {!popup ? (
          <div className="header_wrap">
            ...
            <div class="header_content" id="second_content">
              <div className="plan_filter" onClick={showPopup}>
                <button className="btn_filter" alt="btn_filter">
                  어디든지
                </button>
          ...
          <div id={styles.active_container}>
            ...
            <div className={styles.lower_filter}>
              <div
                className={styles.lower_item}
                id={styles.active_ex}
                style={{ flexGrow: 2 }}
              >
                <div className={styles.lower_names}>여행지</div>
              ...
              <div className={styles.lower_item} style={{ flexGrow: 1 }}>
                <div className={styles.lower_names}>체크인</div>

                <div className={styles.lower_details}>날짜 입력</div>
              </div>

              <div className={styles.lower_item} style={{ flexGrow: 1 }}>
                <div className={styles.lower_names}>체크아웃</div>
              ...
              <div className={styles.lower_search} style={{ flexGrow: 1 }}>
                <div className={styles.lower_item}>
                  <div className={styles.lower_names}>여행자</div>

                  <div className={styles.lower_details}>게스트 추가</div>
                </div>
        ...
        <div className={styles.header_modal}>
          ...
          <div className={styles.hd_container}>
            <div className={styles.hd_item}>
              ...
              <button className={styles.hd_txt}>유연한 검색</button>
            </div>
            <div className={styles.hd_item}>
              ...
              <div className={styles.hd_txt}>유럽</div>
            </div>
            ...
            <div className={styles.hd_item}>
              ...
              <div className={styles.hd_txt}>프랑스</div>
            </div>
            ...
            <div className={styles.hd_item}>
              ...
              <div className={styles.hd_txt}>동남아시아</div>
            </div>
            ...
            <div className={styles.hd_item}>
              ...
              <div className={styles.hd_txt}>이탈리아</div>
            </div>
      ...
      <div className={styles.footer}>
        ...
        <div className={styles.small_footer}>
          ...
          <div className={styles.sfooter_list}>
            ...
            <div className={styles.sfooter_item}>위시리스트</div>
          </div>
          ...
          <div className={styles.sfooter_list}>
            ...
            <div className={styles.sfooter_item}>로그인</div>
          </div>
        </div>
      </div>
    </div>
...
const TripList = (props) => {
  ...
  const [places, setPlaces] = useState(place.place); // 상태로써 places를 설정하고 초기값을 props.places로 설정

  const kind = "섬";
  const kindList = places.filter((place) => place.kind === kind);

  const toggleLike = (id) => {
    setPlaces((prevPlaces) =>
      prevPlaces.map((place) => {
        if (place.id === id) {
          return { ...place, like: !place.like }; // 해당 id의 장소의 like를 반전시킨다.
        }
        return place;
      })
    );
  ...
  return (
    <div className="main_container">
      <div
        className={styles.sookso_container}
        ...
        {kindList.map((place) => (
          <div className={styles.container} key={place.id}>
            ...
            >
              ...
              <LikeIcon
                like={place.like}
                onClick={() => toggleLike(place.id)} // 클릭 시 해당 id의 장소의 like를 변경
...
const LikeIcon = styled.svg`
  fill: ${({ like }) => (like ? "red" : "rgba(0,0,0,0.5)")};
`;
